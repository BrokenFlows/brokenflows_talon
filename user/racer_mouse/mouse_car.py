...
def racer_tick_cb():
    ...
    # print("car now at " + str(racer_position))
...
def racer_canvas_draw(canvas):
    ...
    # canvas.translate(64, 64)
    # canvas.rotate_radians(racer_angle)
    # canvas.translate(-64, -64)

    # canvas.translate(-canvas.x, -canvas.y)
    # canvas.translate(-64, -64)
    #nward right nowthe inward right now canvas.rotate_radians(racer_angle)
    ...
    canvas.draw_point(100 * xpy, 100 * ypy)
